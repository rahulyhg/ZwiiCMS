...
Cette version de ZWII est basée sur la version 8.2.6 dev du développeur qui corrigent une masse de bugs indentifiés à la version 8.2.5. C'est une version presque définitive. 
